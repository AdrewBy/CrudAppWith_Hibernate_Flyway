    ...
    private static synchronized void buildSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                // Добавляем сущности
                configuration.addAnnotatedClass(org.ustsinau.chapter2_3.models.Writer.class);
                configuration.addAnnotatedClass(org.ustsinau.chapter2_3.models.Post.class);
                configuration.addAnnotatedClass(org.ustsinau.chapter2_3.models.Label.class);
